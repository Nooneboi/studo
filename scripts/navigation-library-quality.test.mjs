...
test('Progress shortcuts only target sections that exist and learner-facing data labels use Chee Skool branding', () => {
  ...
  assert.match(js, /Skill evidence reflects your Chee Skool Practice and Train history, not a GED score\./, 'Progress should explain that ordinary skill evidence comes from Practice and Train history, not Skill Check, Mock, or GED scoring');
